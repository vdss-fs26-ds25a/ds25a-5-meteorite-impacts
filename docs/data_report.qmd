...
: Data catalogue for Processed Dataset 1. {#tbl-data-catalogue-processed}

| Column index | Column name | Datatype | Values (Range, validation rules) | Short description |
|--------------|-------------|----------|---------------------------------|-----------------|
| 1 | name | categorical | any string | Name of the meteorite |
| 2 | id | numeric | positive integers 1 to 57455 | Unique identifier of this dataset, not compatible with other datasets |
| 3 | nametype | categorical | "Valid", "Relict" | Indicates if the meteorite name is valid |
| 4 | recclass | categorical | meteorite classification codes (e.g., L5, H6, EH4) | Classification of the meteorite |
| 5 | mass_g | numeric | positive numbers 0.01 to 60000000 g | Mass of the meteorite in grams |
| 6 | fall | categorical | "Fell" or "Found" | Whether it was observed falling or later found |
| 7 | year | integer | 860 to 2013 | Year the meteorite fell or was found |
| 8 | reclat | numeric | -87.37 to 81.17 | Latitude of the find location |
| 9 | reclong | numeric | -165.43 to 178.20 | Longitude of the find location |
| 10 | GeoLocation | categorical | format "(lat, long)" | Combined latitude/longitude |
