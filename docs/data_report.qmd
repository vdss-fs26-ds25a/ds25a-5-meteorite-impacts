...
Die Rohdaten wurden mit der Analyse von dem package ydata_profiling gemacht.
Diese sind hier zu finden[Analyse der Rohdaten](https://vdss-fs26-ds25a.github.io/ds25a-5-fancyproject/meteorite_report.html)
...
| Name | Quelle | Storage location |
|----------------|-----------------------------------------|--------------------------------------------------------------------------|
| Meteorite_Landings_cleaned.csv      | Meteorite_Landings.csv (Raw Dataset 1) | viz_design/Meteorite_Landings_cleaned.csv |
...
The processed dataset is created from the raw dataset by running eda.ipynb. The notebook reads Meteorite_Landings.csv, applies the cleaning steps, and writes the result to viz_design/Meteorite_Landings_cleaned.csv.
